...
void main() {
    ...
    if (gl_InvocationID == 0)
    {
        ...
        vec4 v0 = ubo.view[gl_ViewIndex] * ubo.model * vec4(inPosition[0], 1.0);
        vec4 v1 = ubo.view[gl_ViewIndex] * ubo.model * vec4(inPosition[1], 1.0);
        vec4 v2 = ubo.view[gl_ViewIndex] * ubo.model * vec4(inPosition[2], 1.0);
        vec4 v3 = ubo.view[gl_ViewIndex] * ubo.model * vec4(inPosition[3], 1.0);
